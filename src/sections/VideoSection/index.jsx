                ...
                <div className="container mx-auto my-10">
                    <div className="relative overflow-hidden rounded-3xl">
                        ...
                        <div className="absolute inset-0 flex flex-col gap-2 py-10 justify-end  px-10">
                            ...
                            <h3 className='text-[18px] font-inter text-[#e5e3e3] font-light'>Experience unmatched audio clarity with crafted headphones.</h3>
                           <h4 className=' text-[#e5e3e3] mt-5 flex gap-2'>Shop Now <MoveRight /> </h4>
                        </div>
                    </div>
                </div>
            </section>
