   ...
   <div >
      <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div className='flex flex-col text-[#A1A1AA] text-[14px]'>
          ...
          <p className='mt-5'><span className="font-semibold">Address:</span> 1234 Fashion Street, Suite 567, New York, NY</p>
          <p className="mt-2"><span className="font-semibold">Phone:</span> +123 456 7890</p>
        ...
        <div className=''>
          ...
          <ul className="flex flex-col gap-1 text-sm text-[#A1A1AA] text">
        ...
        <div>
          ...
          <ul className="flex flex-col gap-1 text-sm text-[#A1A1AA]">
        ...
        <div>
          <h3 className="text-lg font-semibold mb-4">Sign Up for Email</h3>
          <p className="text-sm text-gray-300 mb-4">Get first dibs on new arrivals, sales, exclusive content, and more!</p>
          <div className="flex items-center bg-gray-800 rounded-full overflow-hidden mb-2">
